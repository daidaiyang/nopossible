...
public class OneKeyRightItemAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.recycler_onekeysaveorder_right_item, viewGroup, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.rightitem_price)
        TextView rightitemPrice;
