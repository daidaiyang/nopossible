...
public class IntegralSumApi extends BaseApi {



    public IntegralSumApi(HttpOnNextListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpGetService.integralSum();
    }
}
