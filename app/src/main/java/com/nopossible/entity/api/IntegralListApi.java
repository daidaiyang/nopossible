...
public class IntegralListApi extends BaseApi {



    public IntegralListApi(HttpOnNextListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpGetService.integralList();
    }
}
